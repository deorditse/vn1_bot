...
from src.app import __version__, release_notes
...
tags_metadata = [
    {
        ...
        "description": '''
        бот для парсинга сайтов с изъятой техникой, предоставления пользователям удобного интерфейса поиска 
        и автоматического формирования Excel-фида для дальнейшей публикации на сайте.
        ''',
    },
